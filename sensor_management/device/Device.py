...
class Device(IoTElement):
    ...
    def startup(self):
        ...
        self.client.publish('management', json.dumps({"itemid":self.itemid, "address": self.address, "hostname": self.hostname, "event": "startup" , 'message': "Hello world", "timestamp": time.localtime()}))
